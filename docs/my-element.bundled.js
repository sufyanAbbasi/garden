...
const o = globalThis.trustedTypes,
  n = o ? o.createPolicy("lit-html", { createHTML: (t) => t }) : void 0,
  ...
  w = ((t) => (i, ...s) => ({ _$litType$: t, strings: i, values: s }))(1),
  S = Symbol.for("lit-noChange"),
  $ = Symbol.for("lit-nothing"),
  C = new WeakMap(),
  k = u.createTreeWalker(u, 129, null, !1),
  x = (t, i) => {
    const s = t.length - 1,
      e = [];
    let o,
    ...
    for (let i = 0; i < s; i++) {
      ...
      let n,
        ...
        c = -1,
        a = 0;
      for (; a < s.length && ((u.lastIndex = a), (d = u.exec(s)), null !== d); )
        (a = u.lastIndex),
          u === v
            ? "!--" === d[1]
              ? (u = f)
            ...
            ? ">" === d[0]
              ...
              : void 0 === d[1]
              ? (c = -2)
              : ((c = u.lastIndex - d[2].length),
                (n = d[1]),
                (u = void 0 === d[3] ? y : '"' === d[3] ? g : b))
            : u === g || u === b
            ? (u = y)
            : u === f || u === p
            ? (u = v)
            : ((u = y), (o = void 0));
      const w = u === y && t[i + 1].startsWith("/>") ? " " : "";
      l +=
        u === v
          ? s + r
          : c >= 0
          ? (e.push(n), s.slice(0, c) + "$lit$" + s.slice(c) + h + w)
          : s + h + (-2 === c ? (e.push(void 0), i) : w);
    }
    const d = l + (t[s] || "<?>") + (2 === i ? "</svg>" : "");
    return [void 0 !== n ? n.createHTML(d) : d, e];
  };
class T {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    for (; null !== (e = k.nextNode()) && c.length < u; ) {
      if (1 === e.nodeType) {
        if (e.hasAttributes()) {
          const t = [];
          for (const i of e.getAttributeNames())
            if (i.endsWith("$lit$") || i.startsWith(h)) {
              ...
              if ((t.push(i), void 0 !== s)) {
                const t = e.getAttribute(s.toLowerCase() + "$lit$").split(h),
                  i = /([.?@])?(.*)/.exec(s);
                c.push({
                  type: 1,
                  index: n,
        ...
        if (e.data === l) c.push({ type: 2, index: n });
        else {
          let t = -1;
          for (; -1 !== (t = e.data.indexOf(h, t + 1)); )
            c.push({ type: 7, index: n }), (t += h.length - 1);
        }
      n++;
    }
  }
...
function M(t, i, s = t, e) {
  ...
  if (i === S) return i;
  let r =
    void 0 !== e ? (null === (o = s.Σi) || void 0 === o ? void 0 : o[e]) : s.Σo;
  const u = c(i) ? void 0 : i._$litDirective$;
  return (
    (null == r ? void 0 : r.constructor) !== u &&
      (null === (n = null == r ? void 0 : r.O) || void 0 === n || n.call(r, !1),
      void 0 === u ? (r = void 0) : ((r = new u(t)), r.T(t, s, e)),
      void 0 !== e
        ? ((null !== (h = (l = s).Σi) && void 0 !== h ? h : (l.Σi = []))[e] = r)
        : (s.Σo = r)),
    void 0 !== r && (i = M(t, r.S(t, i.values), r, e)),
    i
  );
}
class O {
  ...
  u(t) {
    ...
    for (; void 0 !== r; ) {
      if (h === r.index) {
        let i;
        2 === r.type
          ? (i = new j(n, n.nextSibling, this, t))
          : 1 === r.type
          ? (i = new r.ctor(n, r.name, r.strings, this, t))
          : 6 === r.type && (i = new R(n, this, t)),
          this.l.push(i),
          (r = e[++l]);
      }
      h !== (null == r ? void 0 : r.index) && ((n = k.nextNode()), h++);
    }
    return o;
  }
  v(t) {
...
class j {
  ...
  _(t) {
    ...
    const { values: s, _$litType$: e } = t,
      o =
        "number" == typeof e
          ? this.C(t)
          : (void 0 === e.el && (e.el = T.createElement(e.h, this.options)), e);
    if ((null === (i = this.H) || void 0 === i ? void 0 : i.D) === o)
      this.H.v(s);
    else {
      const t = new O(o, this),
        i = t.u(this.options);
  ...
  C(t) {
    ...
    return void 0 === i && C.set(t.strings, (i = new T(t))), i;
  }
  g(t) {
    ...
    for (const o of t)
      e === i.length
        ? i.push((s = new j(this.k(d()), this.k(d()), this, this.options)))
        : (s = i[e]),
        s.I(o),
        e++;
...
class A {
  constructor(t, i, s, e, o) {
    (this.type = 1),
      ...
      (this.options = o),
      s.length > 2 || "" !== s[0] || "" !== s[1]
        ? ((this.H = Array(s.length - 1).fill($)), (this.strings = s))
        : (this.H = $);
  }
  get tagName() {
...
class U extends A {
  ...
  I(t, i = this) {
    var s;
    if ((t = null !== (s = M(this, t, i, 0)) && void 0 !== s ? s : $) === S)
      return;
    const e = this.H,
      o =
        (t === $ && e !== $) ||
...
const D = {
  ...
  J = (t, i) => i !== t && (i == i || t == t),
  K = { attribute: !0, type: String, converter: D, reflect: !1, hasChanged: J };
class Z extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const t of s) i.unshift(W(t));
    } else void 0 !== t && i.push(W(t));
    return i;
  }
  static Πp(t, i) {
    const s = i.attribute;
  ...
  Πj(t, i, s = K) {
    var e, o;
    const n = this.constructor.Πp(t, s);
    if (void 0 !== n && !0 === s.reflect) {
      const h = (null !==
        (o =
          null === (e = s.converter) || void 0 === e
            ? void 0
            : e.toAttribute) && void 0 !== o
        ? o
        : D.toAttribute)(i, s.type);
      (this.Πh = t),
        null == h ? this.removeAttribute(n) : this.setAttribute(n, h),
        (this.Πh = null);
    }
  }
  K(t, i) {
    ...
    if (void 0 !== h && this.Πh !== h) {
      const t = n.getPropertyOptions(h),
        l = t.converter,
        r =
          null !==
            (o =
            ...
            ? o
            : D.fromAttribute;
      (this.Πh = h), (this[h] = r(i, t.type)), (this.Πh = null);
    }
  }
  requestUpdate(t, i, s) {
    let e = !0;
    void 0 !== t &&
      (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || J)(
        this[t],
        i
      )
...
(Z.finalized = !0),
  ...
  null === (H = (L = globalThis).reactiveElementPlatformSupport) ||
    void 0 === H ||
    H.call(L, { ReactiveElement: Z }),
  (null !== (q = (B = globalThis).reactiveElementVersions) && void 0 !== q
    ? q
    : (B.reactiveElementVersions = [])
  ).push("1.0.0-rc.1"),
  (null !== (V = (Y = globalThis).litElementVersions) && void 0 !== V
    ? V
        ...
        if (void 0 === h) {
          const t =
            null !== (o = null == s ? void 0 : s.renderBefore) && void 0 !== o
              ? o
              : null;
          n._$litPart$ = h = new j(i.insertBefore(d(), t), t, void 0, s);
        }
        return h.I(t), h;
...
(tt.finalized = !0),
  (tt._$litElement$ = !0),
  null === (G = (F = globalThis).litElementHydrateSupport) ||
    void 0 === G ||
    G.call(F, { LitElement: tt }),
  null === (X = (Q = globalThis).litElementPlatformSupport) ||
    void 0 === X ||
    X.call(Q, { LitElement: tt });
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var et = function (t, i, s, e) {
  for (
    ...
    (o = t[l]) && (h = (n < 3 ? o(h) : n > 3 ? o(i, s, h) : o(i, s)) || h);
...
(ot.styles = ((t, ...i) => {
  const s = i.reduce(
    (i, s, e) =>
      i +
      ((t) => {
        if (t instanceof P) return t.cssText;
  ...
  let e = I.get(s);
  return void 0 === e && I.set(s, (e = new P(s, z))), e;
})`
    :host {
      display: block;
  ...
  `),
  et([st()], ot.prototype, "name", void 0),
  et([st({ type: Number })], ot.prototype, "count", void 0),
  (ot = et(
    [
      ((t) => (i) =>
        "function" == typeof i
